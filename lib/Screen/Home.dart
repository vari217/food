          ...
          [
            Container
              ...
              child: Row
                ...
                children: <Widget>
                [
                  Text('Bhogn.com', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
        ...
        body: StaggeredGridView.count(
          ...
          children: <Widget>[
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Total Meals/day', style: TextStyle(color: Colors.blueAccent)),
                          Text('100 ', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                        ],
                      ),
                      Material
                        (
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Meals Info', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('Kitchen Name, Owner', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => NewMeal())),
            ),
            _buildTile(
              Padding
                (
                        ...
                        [
                          Column
                            ...
                            [
                              ...
                              Text('\$800', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                            (
            ...
            _buildTile(
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Kitchen Details', style: TextStyle(color: Colors.redAccent)),
                          Text('Edit/update', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                        ],
                      ),
                      Material
                        (
              ...
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => EditKitchenPage())),
            )
          ],
          staggeredTiles: [
